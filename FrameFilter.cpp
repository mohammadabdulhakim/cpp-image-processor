...
#define CYAN    "\033[36m"
#define BOLD    "\033[1m"
FrameFilter::FrameFilter(Image& img) : Filter(img), R(0), G(0), B(0), Thickness(1), isDecorative(false) {}

string FrameFilter::getName() { return "Frame"; }
string FrameFilter::getId() { return "9"; }

void FrameFilter::getNeeds() {
