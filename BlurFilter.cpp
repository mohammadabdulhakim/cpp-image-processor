...
BlurFilter::BlurFilter(Image& img, int r) : Filter(img), radius(r) {};

string BlurFilter::getName() { return "Blur"; };

string BlurFilter::getId() { return "12"; };

void BlurFilter::Prefix_sum(Image& image, vector<vector<ll>>& prefixR, vector<vector<ll>>& prefixG, vector<vector<ll>>& prefixB)
{
...
void BlurFilter::getNeeds()
{
    cout << "Enter strenght of blur : ";
    cin >> radius;
}
